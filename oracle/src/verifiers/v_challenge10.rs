...
impl ChallengeVerifier for Verifier10 {
    ...
    fn secret_data() -> &'static [u8] {
        &[
            64, 32, 81, 109, 212, 221, 236, 153, 176, 118, 54, 139, 61, 61, 235, 188, 103, 231,
            123, 144, 195, 137, 129, 79, 172, 64, 251, 37, 122, 240, 94, 159, 183, 216, 55, 116,
            154, 239, 193, 75, 91, 108, 53, 119, 231, 197, 210,
        ]
    }
}
